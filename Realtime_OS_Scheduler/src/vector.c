...
// Change value at index with provided element
...
// realloc finds new space and paste all the elements of vector->array there and find memory block having double size of previous alloted memory
